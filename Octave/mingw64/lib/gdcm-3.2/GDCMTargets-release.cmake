...
list(APPEND _cmake_import_check_files_for_gdcmjpeg8 "${_IMPORT_PREFIX}/lib/libgdcmjpeg8.dll.a" "${_IMPORT_PREFIX}/bin/libgdcmjpeg8.dll" )
...
list(APPEND _cmake_import_check_files_for_gdcmjpeg12 "${_IMPORT_PREFIX}/lib/libgdcmjpeg12.dll.a" "${_IMPORT_PREFIX}/bin/libgdcmjpeg12.dll" )
...
list(APPEND _cmake_import_check_files_for_gdcmjpeg16 "${_IMPORT_PREFIX}/lib/libgdcmjpeg16.dll.a" "${_IMPORT_PREFIX}/bin/libgdcmjpeg16.dll" )
...
list(APPEND _cmake_import_check_targets gdcmexpat )
list(APPEND _cmake_import_check_files_for_gdcmexpat "${_IMPORT_PREFIX}/lib/libgdcmexpat.dll.a" "${_IMPORT_PREFIX}/bin/libgdcmexpat.dll" )
...
set_target_properties(gdcmopenjp2 PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libgdcmopenjp2.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libgdcmopenjp2.dll"
  )

list(APPEND _cmake_import_check_targets gdcmopenjp2 )
list(APPEND _cmake_import_check_files_for_gdcmopenjp2 "${_IMPORT_PREFIX}/lib/libgdcmopenjp2.dll.a" "${_IMPORT_PREFIX}/bin/libgdcmopenjp2.dll" )
...
list(APPEND _cmake_import_check_targets gdcmcharls )
list(APPEND _cmake_import_check_files_for_gdcmcharls "${_IMPORT_PREFIX}/lib/libgdcmcharls.dll.a" "${_IMPORT_PREFIX}/bin/libgdcmcharls.dll" )
...
list(APPEND _cmake_import_check_targets gdcmzlib )
list(APPEND _cmake_import_check_files_for_gdcmzlib "${_IMPORT_PREFIX}/lib/libgdcmzlib.dll.a" "${_IMPORT_PREFIX}/bin/libgdcmzlib.dll" )
...
list(APPEND _cmake_import_check_targets socketxx )
list(APPEND _cmake_import_check_files_for_socketxx "${_IMPORT_PREFIX}/lib/libsocketxx.dll.a" "${_IMPORT_PREFIX}/bin/libsocketxx.dll" )
...
list(APPEND _cmake_import_check_files_for_gdcmCommon "${_IMPORT_PREFIX}/lib/libgdcmCommon.dll.a" "${_IMPORT_PREFIX}/bin/libgdcmCommon.dll" )
...
list(APPEND _cmake_import_check_files_for_gdcmDICT "${_IMPORT_PREFIX}/lib/libgdcmDICT.dll.a" "${_IMPORT_PREFIX}/bin/libgdcmDICT.dll" )
...
list(APPEND _cmake_import_check_files_for_gdcmDSED "${_IMPORT_PREFIX}/lib/libgdcmDSED.dll.a" "${_IMPORT_PREFIX}/bin/libgdcmDSED.dll" )
...
list(APPEND _cmake_import_check_files_for_gdcmIOD "${_IMPORT_PREFIX}/lib/libgdcmIOD.dll.a" "${_IMPORT_PREFIX}/bin/libgdcmIOD.dll" )
...
list(APPEND _cmake_import_check_files_for_gdcmMSFF "${_IMPORT_PREFIX}/lib/libgdcmMSFF.dll.a" "${_IMPORT_PREFIX}/bin/libgdcmMSFF.dll" )
...
list(APPEND _cmake_import_check_files_for_gdcmMEXD "${_IMPORT_PREFIX}/lib/libgdcmMEXD.dll.a" "${_IMPORT_PREFIX}/bin/libgdcmMEXD.dll" )
