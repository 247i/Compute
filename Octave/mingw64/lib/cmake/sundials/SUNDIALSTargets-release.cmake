...
set_target_properties(SUNDIALS::core_shared PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libsundials_core.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_core.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::core_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::core_shared "${_IMPORT_PREFIX}/lib/libsundials_core.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_core.dll" )
...
set_target_properties(SUNDIALS::nvecserial_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_nvecserial.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::nvecserial_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::nvecserial_shared "${_IMPORT_PREFIX}/lib/libsundials_nvecserial.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_nvecserial.dll" )
...
set_target_properties(SUNDIALS::nvecmanyvector_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_nvecmanyvector.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::nvecmanyvector_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::nvecmanyvector_shared "${_IMPORT_PREFIX}/lib/libsundials_nvecmanyvector.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_nvecmanyvector.dll" )
...
set_target_properties(SUNDIALS::sunmatrixband_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_sunmatrixband.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::sunmatrixband_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::sunmatrixband_shared "${_IMPORT_PREFIX}/lib/libsundials_sunmatrixband.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_sunmatrixband.dll" )
...
set_target_properties(SUNDIALS::sunmatrixdense_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_sunmatrixdense.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::sunmatrixdense_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::sunmatrixdense_shared "${_IMPORT_PREFIX}/lib/libsundials_sunmatrixdense.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_sunmatrixdense.dll" )
...
set_target_properties(SUNDIALS::sunmatrixsparse_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_sunmatrixsparse.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::sunmatrixsparse_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::sunmatrixsparse_shared "${_IMPORT_PREFIX}/lib/libsundials_sunmatrixsparse.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_sunmatrixsparse.dll" )
...
set_target_properties(SUNDIALS::sunlinsolband_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_sunlinsolband.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::sunlinsolband_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::sunlinsolband_shared "${_IMPORT_PREFIX}/lib/libsundials_sunlinsolband.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_sunlinsolband.dll" )
...
set_target_properties(SUNDIALS::sunlinsoldense_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_sunlinsoldense.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::sunlinsoldense_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::sunlinsoldense_shared "${_IMPORT_PREFIX}/lib/libsundials_sunlinsoldense.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_sunlinsoldense.dll" )
...
set_target_properties(SUNDIALS::sunlinsolpcg_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_sunlinsolpcg.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::sunlinsolpcg_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::sunlinsolpcg_shared "${_IMPORT_PREFIX}/lib/libsundials_sunlinsolpcg.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_sunlinsolpcg.dll" )
...
set_target_properties(SUNDIALS::sunlinsolspbcgs_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_sunlinsolspbcgs.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::sunlinsolspbcgs_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::sunlinsolspbcgs_shared "${_IMPORT_PREFIX}/lib/libsundials_sunlinsolspbcgs.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_sunlinsolspbcgs.dll" )
...
set_target_properties(SUNDIALS::sunlinsolspfgmr_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_sunlinsolspfgmr.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::sunlinsolspfgmr_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::sunlinsolspfgmr_shared "${_IMPORT_PREFIX}/lib/libsundials_sunlinsolspfgmr.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_sunlinsolspfgmr.dll" )
...
set_target_properties(SUNDIALS::sunlinsolspgmr_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_sunlinsolspgmr.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::sunlinsolspgmr_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::sunlinsolspgmr_shared "${_IMPORT_PREFIX}/lib/libsundials_sunlinsolspgmr.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_sunlinsolspgmr.dll" )
...
set_target_properties(SUNDIALS::sunlinsolsptfqmr_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_sunlinsolsptfqmr.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::sunlinsolsptfqmr_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::sunlinsolsptfqmr_shared "${_IMPORT_PREFIX}/lib/libsundials_sunlinsolsptfqmr.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_sunlinsolsptfqmr.dll" )
...
set_target_properties(SUNDIALS::sunlinsolklu_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_sunlinsolklu.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::sunlinsolklu_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::sunlinsolklu_shared "${_IMPORT_PREFIX}/lib/libsundials_sunlinsolklu.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_sunlinsolklu.dll" )
...
set_target_properties(SUNDIALS::sunnonlinsolnewton_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_sunnonlinsolnewton.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::sunnonlinsolnewton_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::sunnonlinsolnewton_shared "${_IMPORT_PREFIX}/lib/libsundials_sunnonlinsolnewton.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_sunnonlinsolnewton.dll" )
...
set_target_properties(SUNDIALS::sunnonlinsolfixedpoint_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_sunnonlinsolfixedpoint.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::sunnonlinsolfixedpoint_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::sunnonlinsolfixedpoint_shared "${_IMPORT_PREFIX}/lib/libsundials_sunnonlinsolfixedpoint.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_sunnonlinsolfixedpoint.dll" )
...
set_target_properties(SUNDIALS::sundomeigestpower_shared PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libsundials_sundomeigestpower.dll.a"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_sundomeigestpower.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::sundomeigestpower_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::sundomeigestpower_shared "${_IMPORT_PREFIX}/lib/libsundials_sundomeigestpower.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_sundomeigestpower.dll" )
...
set_target_properties(SUNDIALS::ida_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsundials_ida.dll"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::ida_shared )
list(APPEND _cmake_import_check_files_for_SUNDIALS::ida_shared "${_IMPORT_PREFIX}/lib/libsundials_ida.dll.a" "${_IMPORT_PREFIX}/bin/libsundials_ida.dll" )
