...
set(_installed_components "ida;sundomeigestpower;sunnonlinsolfixedpoint;sunnonlinsolnewton;sunlinsolklu;sunlinsolsptfqmr;sunlinsolspgmr;sunlinsolspfgmr;sunlinsolspbcgs;sunlinsolpcg;sunlinsoldense;sunlinsolband;sunmatrixsparse;sunmatrixdense;sunmatrixband;nvecmanyvector;nvecserial;core;")
...
if("ON" AND NOT TARGET SUNDIALS::KLU)
  if("ON")
    ...
    target_link_libraries(SUNDIALS::KLU INTERFACE "/scratch/build/mxe-octave-w64/usr/x86_64-w64-mingw32/lib/libklu.dll.a")
    set_target_properties(SUNDIALS::KLU PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "/scratch/build/mxe-octave-w64/usr/x86_64-w64-mingw32/include/suitesparse")
  endif()
endif()
