...
## -*- texinfo -*-
## @deftypefn {} {} __init_linear_algebra__ ()
## Undocumented internal function of linear-algebra package.
##
## Register Qt help files for GUI doc browser.
##
## @end deftypefn

## PKG_ADD: __init_linear_algebra__ ()

function __init_linear_algebra__ ()

  ## Package documentation
  ## On package load, attempt to load docs
  try
    pkg_dir = fileparts (fullfile (mfilename ("fullpath")));
    doc_file = fullfile (pkg_dir, "doc", "linear-algebra.qch");
