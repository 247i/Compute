...
## -*- texinfo -*-
## @deftypefn {} {} __exit_linear_algebra__ ()
## Undocumented internal function of linear_algebra package.
##
## Deregister Qt help files for GUI doc browser.
##
## @end deftypefn

## PKG_DEL: __exit_linear_algebra__ ()

function __exit_linear_algebra__ ()
