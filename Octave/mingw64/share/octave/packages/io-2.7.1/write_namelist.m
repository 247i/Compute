## Copyright (C) 2011-2026 Darien Pardinas Diaz <darien.pardinas-diaz@monash.edu>
## Copyright (C) 2016-2026 Philip Nienhuis <prnienhuis@users.sf.net>
##
...
## -*- texinfo -*-
## @deftypefn {function file} @var{ret} = weite_namelist (@var{s})
##
