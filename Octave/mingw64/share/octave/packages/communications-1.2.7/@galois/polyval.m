...
##
## Evaluate the (Galois field) polynomial @var{p} at the specified values of @var{x}.
##
...
## supplied.
##
## This is stripped down from the Octave core @code{polyval} function, which no longer works with Galois inputs.
## @end deftypefn
