...
#include "Sparse-op-defs.h"
  ...
  extern OCTAVE_API ComplexMatrix quotient (const ComplexMatrix&, const SparseMatrix&);
  ...
  extern OCTAVE_API boolMatrix mx_el_or (const ComplexMatrix&, const SparseMatrix&);
#endif
