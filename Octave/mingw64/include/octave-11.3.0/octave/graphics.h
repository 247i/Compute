...
public:
  ...
  bool is_beingdeleted () const { return m_beingdeleted.is_on (); }
  std::string get_beingdeleted () const { return m_beingdeleted.current_value (); }

  bool busyaction_is (const std::string& v) const { return m_busyaction.is (v); }
  std::string get_busyaction () const { return m_busyaction.current_value (); }

  void execute_buttondownfcn (const octave_value& new_data = octave_value ()) const { m_buttondownfcn.execute (new_data); }
  octave_value get_buttondownfcn () const { return m_buttondownfcn.get (); }

  bool is_clipping () const { return m_clipping.is_on (); }
  std::string get_clipping () const { return m_clipping.current_value (); }

  graphics_handle get_contextmenu () const { return m_contextmenu.handle_value (); }

  void execute_createfcn (const octave_value& new_data = octave_value ()) const { m_createfcn.execute (new_data); }
  octave_value get_createfcn () const { return m_createfcn.get (); }

  void execute_deletefcn (const octave_value& new_data = octave_value ()) const { m_deletefcn.execute (new_data); }
  octave_value get_deletefcn () const { return m_deletefcn.get (); }

  bool handlevisibility_is (const std::string& v) const { return m_handlevisibility.is (v); }
  std::string get_handlevisibility () const { return m_handlevisibility.current_value (); }

  bool is_hittest () const { return m_hittest.is_on (); }
  std::string get_hittest () const { return m_hittest.current_value (); }

  bool is_interruptible () const { return m_interruptible.is_on (); }
  std::string get_interruptible () const { return m_interruptible.current_value (); }

  graphics_handle get_parent () const { return m_parent.handle_value (); }

  bool pickableparts_is (const std::string& v) const { return m_pickableparts.is (v); }
  std::string get_pickableparts () const { return m_pickableparts.current_value (); }

  bool is_selected () const { return m_selected.is_on (); }
  std::string get_selected () const { return m_selected.current_value (); }

  bool is_selectionhighlight () const { return m_selectionhighlight.is_on (); }
  std::string get_selectionhighlight () const { return m_selectionhighlight.current_value (); }

  std::string get_tag () const { return m_tag.string_value (); }

  std::string get_type () const { return m_type.string_value (); }

  octave_value get_userdata () const { return m_userdata.get (); }

  bool is_visible () const { return m_visible.is_on (); }
  std::string get_visible () const { return m_visible.current_value (); }

  octave_value get___appdata__ () const { return m___appdata__.get (); }

  bool is___modified__ () const { return m___modified__.is_on (); }
  std::string get___modified__ () const { return m___modified__.current_value (); }

  graphics_handle get___myhandle__ () const { return m___myhandle__; }
...
public:
  ...
  OCTAVE_DISABLE_COPY_MOVE (properties)
  ...
  std::string graphics_object_name () const { return s_go_name; }
...
public:
  ...
  graphics_handle get_callbackobject () const { return m_callbackobject.handle_value (); }

  octave_value get_commandwindowsize () const { return m_commandwindowsize.get (); }

  graphics_handle get_currentfigure () const { return m_currentfigure.handle_value (); }

  std::string get_fixedwidthfontname () const { return m_fixedwidthfontname.string_value (); }

  octave_value get_monitorpositions () const { return m_monitorpositions.get (); }

  octave_value get_pointerlocation () const { return m_pointerlocation.get (); }

  double get_pointerwindow () const { return m_pointerwindow.double_value (); }

  double get_screendepth () const { return m_screendepth.double_value (); }

  double get_screenpixelsperinch () const { return m_screenpixelsperinch.double_value (); }

  octave_value get_screensize () const { return m_screensize.get (); }

  bool is_showhiddenhandles () const { return m_showhiddenhandles.is_on (); }
  std::string get_showhiddenhandles () const { return m_showhiddenhandles.current_value (); }

  bool units_is (const std::string& v) const { return m_units.is (v); }
  std::string get_units () const { return m_units.current_value (); }
...
public:
  ...
  enum
  {
    ...
    ID_INNERPOSITION = 2012,
    ID_INTEGERHANDLE = 2013,
    ID_INVERTHARDCOPY = 2014,
    ID_KEYPRESSFCN = 2015,
    ID_KEYRELEASEFCN = 2016,
    ID_MENUBAR = 2017,
    ID_NAME = 2018,
    ID_NUMBER = 2019,
    ID_NEXTPLOT = 2020,
    ID_NUMBERTITLE = 2021,
    ID_OUTERPOSITION = 2022,
    ID_PAPERORIENTATION = 2023,
    ID_PAPERPOSITION = 2024,
    ID_PAPERPOSITIONMODE = 2025,
    ID_PAPERSIZE = 2026,
    ID_PAPERTYPE = 2027,
    ID_PAPERUNITS = 2028,
    ID_POINTER = 2029,
    ...
    ID_SIZECHANGEDFCN = 2038,
    ID_TOOLBAR = 2039,
    ID_UNITS = 2040,
    ID_WINDOWBUTTONDOWNFCN = 2041,
    ID_WINDOWBUTTONMOTIONFCN = 2042,
    ID_WINDOWBUTTONUPFCN = 2043,
    ID_WINDOWKEYPRESSFCN = 2044,
    ID_WINDOWKEYRELEASEFCN = 2045,
    ID_WINDOWSCROLLWHEELFCN = 2046,
    ID_WINDOWSTATE = 2047,
    ID_WINDOWSTYLE = 2048,
    ID_PICKABLEPARTS = 2049,
    ID___GL_EXTENSIONS__ = 2050,
    ID___GL_RENDERER__ = 2051,
    ID___GL_VENDOR__ = 2052,
    ID___GL_VERSION__ = 2053,
    ID___GL_WINDOW__ = 2054,
    ID___GRAPHICS_TOOLKIT__ = 2055,
    ID___GUIDATA__ = 2056,
    ID___MOUSE_MODE__ = 2057,
    ID___PRINTING__ = 2058,
    ID___PAN_MODE__ = 2059,
    ID___PLOT_STREAM__ = 2060,
    ID___ROTATE_MODE__ = 2061,
    ID___ZOOM_MODE__ = 2062,
    ID___DEVICE_PIXEL_RATIO__ = 2063
  };

  octave_value get_alphamap () const { return m_alphamap.get (); }

  void execute_buttondownfcn (const octave_value& new_data = octave_value ()) const { m_buttondownfcn.execute (new_data); }
  octave_value get_buttondownfcn () const { return m_buttondownfcn.get (); }

  void execute_closerequestfcn (const octave_value& new_data = octave_value ()) const { m_closerequestfcn.execute (new_data); }
  octave_value get_closerequestfcn () const { return m_closerequestfcn.get (); }

  bool color_is_rgb () const { return m_color.is_rgb (); }
  bool color_is (const std::string& v) const { return m_color.is (v); }
  Matrix get_color_rgb () const { return (m_color.is_rgb () ? m_color.rgb () : Matrix ()); }
  octave_value get_color () const { return m_color.get (); }

  octave_value get_colormap () const { return m_colormap.get (); }

  graphics_handle get_currentaxes () const { return m_currentaxes.handle_value (); }

  std::string get_currentcharacter () const { return m_currentcharacter.string_value (); }

  graphics_handle get_currentobject () const { return m_currentobject.handle_value (); }

  octave_value get_currentpoint () const { return m_currentpoint.get (); }

  bool is_dockcontrols () const { return m_dockcontrols.is_on (); }
  std::string get_dockcontrols () const { return m_dockcontrols.current_value (); }

  std::string get_filename () const { return m_filename.string_value (); }

  bool is_graphicssmoothing () const { return m_graphicssmoothing.is_on (); }
  std::string get_graphicssmoothing () const { return m_graphicssmoothing.current_value (); }

  bool is_integerhandle () const { return m_integerhandle.is_on (); }
  std::string get_integerhandle () const { return m_integerhandle.current_value (); }

  bool is_inverthardcopy () const { return m_inverthardcopy.is_on (); }
  std::string get_inverthardcopy () const { return m_inverthardcopy.current_value (); }

  void execute_keypressfcn (const octave_value& new_data = octave_value ()) const { m_keypressfcn.execute (new_data); }
  octave_value get_keypressfcn () const { return m_keypressfcn.get (); }

  void execute_keyreleasefcn (const octave_value& new_data = octave_value ()) const { m_keyreleasefcn.execute (new_data); }
  octave_value get_keyreleasefcn () const { return m_keyreleasefcn.get (); }

  bool menubar_is (const std::string& v) const { return m_menubar.is (v); }
  std::string get_menubar () const { return m_menubar.current_value (); }

  std::string get_name () const { return m_name.string_value (); }

  octave_value get_number () const;

  bool nextplot_is (const std::string& v) const { return m_nextplot.is (v); }
  std::string get_nextplot () const { return m_nextplot.current_value (); }

  bool is_numbertitle () const { return m_numbertitle.is_on (); }
  std::string get_numbertitle () const { return m_numbertitle.current_value (); }

  octave_value get_outerposition () const { return m_outerposition.get (); }

  bool paperorientation_is (const std::string& v) const { return m_paperorientation.is (v); }
  std::string get_paperorientation () const { return m_paperorientation.current_value (); }

  octave_value get_paperposition () const { return m_paperposition.get (); }

  bool paperpositionmode_is (const std::string& v) const { return m_paperpositionmode.is (v); }
  std::string get_paperpositionmode () const { return m_paperpositionmode.current_value (); }

  octave_value get_papersize () const { return m_papersize.get (); }

  bool papertype_is (const std::string& v) const { return m_papertype.is (v); }
  std::string get_papertype () const { return m_papertype.current_value (); }

  bool paperunits_is (const std::string& v) const { return m_paperunits.is (v); }
  std::string get_paperunits () const { return m_paperunits.current_value (); }

  bool pointer_is (const std::string& v) const { return m_pointer.is (v); }
  std::string get_pointer () const { return m_pointer.current_value (); }

  octave_value get_pointershapecdata () const { return m_pointershapecdata.get (); }

  octave_value get_pointershapehotspot () const { return m_pointershapehotspot.get (); }

  octave_value get_position () const { return m_position.get (); }

  bool renderer_is (const std::string& v) const { return m_renderer.is (v); }
  std::string get_renderer () const { return m_renderer.current_value (); }

  bool renderermode_is (const std::string& v) const { return m_renderermode.is (v); }
  std::string get_renderermode () const { return m_renderermode.current_value (); }

  bool is_resize () const { return m_resize.is_on (); }
  std::string get_resize () const { return m_resize.current_value (); }

  void execute_resizefcn (const octave_value& new_data = octave_value ()) const { m_resizefcn.execute (new_data); }
  octave_value get_resizefcn () const { return m_resizefcn.get (); }

  bool selectiontype_is (const std::string& v) const { return m_selectiontype.is (v); }
  std::string get_selectiontype () const { return m_selectiontype.current_value (); }

  void execute_sizechangedfcn (const octave_value& new_data = octave_value ()) const { m_sizechangedfcn.execute (new_data); }
  octave_value get_sizechangedfcn () const { return m_sizechangedfcn.get (); }

  bool toolbar_is (const std::string& v) const { return m_toolbar.is (v); }
  std::string get_toolbar () const { return m_toolbar.current_value (); }

  bool units_is (const std::string& v) const { return m_units.is (v); }
  std::string get_units () const { return m_units.current_value (); }

  void execute_windowbuttondownfcn (const octave_value& new_data = octave_value ()) const { m_windowbuttondownfcn.execute (new_data); }
  octave_value get_windowbuttondownfcn () const { return m_windowbuttondownfcn.get (); }
  ...
  octave_value get_windowbuttonmotionfcn () const { return m_windowbuttonmotionfcn.get (); }

  void execute_windowbuttonupfcn (const octave_value& new_data = octave_value ()) const { m_windowbuttonupfcn.execute (new_data); }
  octave_value get_windowbuttonupfcn () const { return m_windowbuttonupfcn.get (); }

  void execute_windowkeypressfcn (const octave_value& new_data = octave_value ()) const { m_windowkeypressfcn.execute (new_data); }
  octave_value get_windowkeypressfcn () const { return m_windowkeypressfcn.get (); }

  void execute_windowkeyreleasefcn (const octave_value& new_data = octave_value ()) const { m_windowkeyreleasefcn.execute (new_data); }
  octave_value get_windowkeyreleasefcn () const { return m_windowkeyreleasefcn.get (); }

  void execute_windowscrollwheelfcn (const octave_value& new_data = octave_value ()) const { m_windowscrollwheelfcn.execute (new_data); }
  octave_value get_windowscrollwheelfcn () const { return m_windowscrollwheelfcn.get (); }

  bool windowstate_is (const std::string& v) const { return m_windowstate.is (v); }
  std::string get_windowstate () const { return m_windowstate.current_value (); }

  bool windowstyle_is (const std::string& v) const { return m_windowstyle.is (v); }
  std::string get_windowstyle () const { return m_windowstyle.current_value (); }

  bool pickableparts_is (const std::string& v) const { return m_pickableparts.is (v); }
  std::string get_pickableparts () const { return m_pickableparts.current_value (); }

  std::string get___gl_extensions__ () const { return m___gl_extensions__.string_value (); }

  std::string get___gl_renderer__ () const { return m___gl_renderer__.string_value (); }

  std::string get___gl_vendor__ () const { return m___gl_vendor__.string_value (); }

  std::string get___gl_version__ () const { return m___gl_version__.string_value (); }

  bool is___gl_window__ () const { return m___gl_window__.is_on (); }
  std::string get___gl_window__ () const { return m___gl_window__.current_value (); }

  std::string get___graphics_toolkit__ () const { return m___graphics_toolkit__.string_value (); }

  octave_value get___guidata__ () const { return m___guidata__.get (); }

  bool __mouse_mode___is (const std::string& v) const { return m___mouse_mode__.is (v); }
  std::string get___mouse_mode__ () const { return m___mouse_mode__.current_value (); }

  bool is___printing__ () const { return m___printing__.is_on (); }
  std::string get___printing__ () const { return m___printing__.current_value (); }

  octave_value get___pan_mode__ () const { return m___pan_mode__.get (); }

  octave_value get___plot_stream__ () const { return m___plot_stream__.get (); }

  octave_value get___rotate_mode__ () const { return m___rotate_mode__.get (); }

  octave_value get___zoom_mode__ () const { return m___zoom_mode__.get (); }

  double get___device_pixel_ratio__ () const { return m___device_pixel_ratio__.double_value (); }
...
public:
  ...
  enum
  {
    ...
    ID_XLABEL = 3079,
    ID_XLIM = 3080,
    ID_XLIMITMETHOD = 3081,
    ID_XLIMMODE = 3082,
    ID_XMINORGRID = 3083,
    ID_XMINORTICK = 3084,
    ID_XMINORTICKVALUES = 3085,
    ID_XMINORTICKVALUESMODE = 3086,
    ID_XSCALE = 3087,
    ID_XTICK = 3088,
    ID_XTICKLABEL = 3089,
    ID_XTICKLABELMODE = 3090,
    ID_XTICKLABELROTATION = 3091,
    ID_XTICKMODE = 3092,
    ID_YAXIS = 3093,
    ID_YAXISLOCATION = 3094,
    ID_YCOLOR = 3095,
    ID_YCOLORMODE = 3096,
    ID_YDIR = 3097,
    ID_YGRID = 3098,
    ID_YLABEL = 3099,
    ID_YLIM = 3100,
    ID_YLIMITMETHOD = 3101,
    ID_YLIMMODE = 3102,
    ID_YMINORGRID = 3103,
    ID_YMINORTICK = 3104,
    ID_YMINORTICKVALUES = 3105,
    ID_YMINORTICKVALUESMODE = 3106,
    ID_YSCALE = 3107,
    ID_YTICK = 3108,
    ID_YTICKLABEL = 3109,
    ID_YTICKLABELMODE = 3110,
    ID_YTICKLABELROTATION = 3111,
    ID_YTICKMODE = 3112,
    ID_ZAXIS = 3113,
    ID_ZCOLOR = 3114,
    ID_ZCOLORMODE = 3115,
    ...
    ID_ZLABEL = 3118,
    ID_ZLIM = 3119,
    ID_ZLIMITMETHOD = 3120,
    ID_ZLIMMODE = 3121,
    ID_ZMINORGRID = 3122,
    ID_ZMINORTICK = 3123,
    ID_ZMINORTICKVALUES = 3124,
    ID_ZMINORTICKVALUESMODE = 3125,
    ID_ZSCALE = 3126,
    ID_ZTICK = 3127,
    ID_ZTICKLABEL = 3128,
    ID_ZTICKLABELMODE = 3129,
    ID_ZTICKLABELROTATION = 3130,
    ID_ZTICKMODE = 3131,
    ID___COLORMAP__ = 3132,
    ID_MOUSEWHEELZOOM = 3133,
    ID___AUTOPOS_TAG__ = 3134,
    ID_LOOSEINSET = 3135,
    ID___FONTSIZE_POINTS__ = 3136
  };

  octave_value get_alim () const { return m_alim.get (); }

  bool alimmode_is (const std::string& v) const { return m_alimmode.is (v); }
  std::string get_alimmode () const { return m_alimmode.current_value (); }

  octave_value get_alphamap () const { return m_alphamap.get (); }

  bool alphascale_is (const std::string& v) const { return m_alphascale.is (v); }
  std::string get_alphascale () const { return m_alphascale.current_value (); }

  bool ambientlightcolor_is_rgb () const { return m_ambientlightcolor.is_rgb (); }
  bool ambientlightcolor_is (const std::string& v) const { return m_ambientlightcolor.is (v); }
  Matrix get_ambientlightcolor_rgb () const { return (m_ambientlightcolor.is_rgb () ? m_ambientlightcolor.rgb () : Matrix ()); }
  octave_value get_ambientlightcolor () const { return m_ambientlightcolor.get (); }

  bool is_box () const { return m_box.is_on (); }
  std::string get_box () const { return m_box.current_value (); }

  bool boxstyle_is (const std::string& v) const { return m_boxstyle.is (v); }
  std::string get_boxstyle () const { return m_boxstyle.current_value (); }

  octave_value get_cameraposition () const { return m_cameraposition.get (); }

  bool camerapositionmode_is (const std::string& v) const { return m_camerapositionmode.is (v); }
  std::string get_camerapositionmode () const { return m_camerapositionmode.current_value (); }

  octave_value get_cameratarget () const { return m_cameratarget.get (); }

  bool cameratargetmode_is (const std::string& v) const { return m_cameratargetmode.is (v); }
  std::string get_cameratargetmode () const { return m_cameratargetmode.current_value (); }

  octave_value get_cameraupvector () const { return m_cameraupvector.get (); }

  bool cameraupvectormode_is (const std::string& v) const { return m_cameraupvectormode.is (v); }
  std::string get_cameraupvectormode () const { return m_cameraupvectormode.current_value (); }

  double get_cameraviewangle () const { return m_cameraviewangle.double_value (); }

  bool cameraviewanglemode_is (const std::string& v) const { return m_cameraviewanglemode.is (v); }
  std::string get_cameraviewanglemode () const { return m_cameraviewanglemode.current_value (); }

  octave_value get_clim () const { return m_clim.get (); }

  bool climmode_is (const std::string& v) const { return m_climmode.is (v); }
  std::string get_climmode () const { return m_climmode.current_value (); }

  bool clippingstyle_is (const std::string& v) const { return m_clippingstyle.is (v); }
  std::string get_clippingstyle () const { return m_clippingstyle.current_value (); }
  ...
  octave_value get_colororder () const { return m_colororder.get (); }

  double get_colororderindex () const { return m_colororderindex.double_value (); }

  bool colorscale_is (const std::string& v) const { return m_colorscale.is (v); }
  std::string get_colorscale () const { return m_colorscale.current_value (); }

  octave_value get_currentpoint () const { return m_currentpoint.get (); }

  octave_value get_dataaspectratio () const { return m_dataaspectratio.get (); }

  bool dataaspectratiomode_is (const std::string& v) const { return m_dataaspectratiomode.is (v); }
  std::string get_dataaspectratiomode () const { return m_dataaspectratiomode.current_value (); }

  bool fontangle_is (const std::string& v) const { return m_fontangle.is (v); }
  std::string get_fontangle () const { return m_fontangle.current_value (); }

  std::string get_fontname () const { return m_fontname.string_value (); }

  double get_fontsize () const { return m_fontsize.double_value (); }

  bool fontsizemode_is (const std::string& v) const { return m_fontsizemode.is (v); }
  std::string get_fontsizemode () const { return m_fontsizemode.current_value (); }

  bool is_fontsmoothing () const { return m_fontsmoothing.is_on (); }
  std::string get_fontsmoothing () const { return m_fontsmoothing.current_value (); }

  bool fontunits_is (const std::string& v) const { return m_fontunits.is (v); }
  std::string get_fontunits () const { return m_fontunits.current_value (); }

  bool fontweight_is (const std::string& v) const { return m_fontweight.is (v); }
  std::string get_fontweight () const { return m_fontweight.current_value (); }

  double get_gridalpha () const { return m_gridalpha.double_value (); }

  bool gridalphamode_is (const std::string& v) const { return m_gridalphamode.is (v); }
  std::string get_gridalphamode () const { return m_gridalphamode.current_value (); }

  bool gridcolor_is_rgb () const { return m_gridcolor.is_rgb (); }
  bool gridcolor_is (const std::string& v) const { return m_gridcolor.is (v); }
  Matrix get_gridcolor_rgb () const { return (m_gridcolor.is_rgb () ? m_gridcolor.rgb () : Matrix ()); }
  octave_value get_gridcolor () const { return m_gridcolor.get (); }

  bool gridcolormode_is (const std::string& v) const { return m_gridcolormode.is (v); }
  std::string get_gridcolormode () const { return m_gridcolormode.current_value (); }

  bool gridlinestyle_is (const std::string& v) const { return m_gridlinestyle.is (v); }
  std::string get_gridlinestyle () const { return m_gridlinestyle.current_value (); }

  octave_value get_interactions () const { return m_interactions.get (); }

  double get_labelfontsizemultiplier () const { return m_labelfontsizemultiplier.double_value (); }

  bool layer_is (const std::string& v) const { return m_layer.is (v); }
  std::string get_layer () const { return m_layer.current_value (); }

  graphics_handle get_layout () const { return m_layout.handle_value (); }

  graphics_handle get_legend () const { return m_legend.handle_value (); }

  octave_value get_linestyleorder () const { return m_linestyleorder.get (); }

  double get_linestyleorderindex () const { return m_linestyleorderindex.double_value (); }

  double get_linewidth () const { return m_linewidth.double_value (); }

  double get_minorgridalpha () const { return m_minorgridalpha.double_value (); }

  bool minorgridalphamode_is (const std::string& v) const { return m_minorgridalphamode.is (v); }
  std::string get_minorgridalphamode () const { return m_minorgridalphamode.current_value (); }

  bool minorgridcolor_is_rgb () const { return m_minorgridcolor.is_rgb (); }
  bool minorgridcolor_is (const std::string& v) const { return m_minorgridcolor.is (v); }
  Matrix get_minorgridcolor_rgb () const { return (m_minorgridcolor.is_rgb () ? m_minorgridcolor.rgb () : Matrix ()); }
  octave_value get_minorgridcolor () const { return m_minorgridcolor.get (); }

  bool minorgridcolormode_is (const std::string& v) const { return m_minorgridcolormode.is (v); }
  std::string get_minorgridcolormode () const { return m_minorgridcolormode.current_value (); }

  bool minorgridlinestyle_is (const std::string& v) const { return m_minorgridlinestyle.is (v); }
  std::string get_minorgridlinestyle () const { return m_minorgridlinestyle.current_value (); }

  bool nextplot_is (const std::string& v) const { return m_nextplot.is (v); }
  std::string get_nextplot () const { return m_nextplot.current_value (); }

  double get_nextseriesindex () const { return m_nextseriesindex.double_value (); }

  octave_value get_outerposition () const { return m_outerposition.get (); }

  octave_value get_plotboxaspectratio () const { return m_plotboxaspectratio.get (); }

  bool plotboxaspectratiomode_is (const std::string& v) const { return m_plotboxaspectratiomode.is (v); }
  std::string get_plotboxaspectratiomode () const { return m_plotboxaspectratiomode.current_value (); }

  octave_value get_position () const { return m_position.get (); }

  bool positionconstraint_is (const std::string& v) const { return m_positionconstraint.is (v); }
  std::string get_positionconstraint () const { return m_positionconstraint.current_value (); }

  bool projection_is (const std::string& v) const { return m_projection.is (v); }
  std::string get_projection () const { return m_projection.current_value (); }

  bool sortmethod_is (const std::string& v) const { return m_sortmethod.is (v); }
  std::string get_sortmethod () const { return m_sortmethod.current_value (); }

  bool tickdir_is (const std::string& v) const { return m_tickdir.is (v); }
  std::string get_tickdir () const { return m_tickdir.current_value (); }

  bool tickdirmode_is (const std::string& v) const { return m_tickdirmode.is (v); }
  std::string get_tickdirmode () const { return m_tickdirmode.current_value (); }

  bool ticklabelinterpreter_is (const std::string& v) const { return m_ticklabelinterpreter.is (v); }
  std::string get_ticklabelinterpreter () const { return m_ticklabelinterpreter.current_value (); }

  octave_value get_ticklength () const { return m_ticklength.get (); }

  octave_value get_tightinset () const { return m_tightinset.get (); }

  graphics_handle get_title () const { return m_title.handle_value (); }

  double get_titlefontsizemultiplier () const { return m_titlefontsizemultiplier.double_value (); }

  bool titlefontweight_is (const std::string& v) const { return m_titlefontweight.is (v); }
  std::string get_titlefontweight () const { return m_titlefontweight.current_value (); }

  graphics_handle get_toolbar () const { return m_toolbar.handle_value (); }

  bool units_is (const std::string& v) const { return m_units.is (v); }
  std::string get_units () const { return m_units.current_value (); }

  octave_value get_view () const { return m_view.get (); }

  graphics_handle get_xaxis () const { return m_xaxis.handle_value (); }

  bool xaxislocation_is (const std::string& v) const { return m_xaxislocation.is (v); }
  std::string get_xaxislocation () const { return m_xaxislocation.current_value (); }

  bool xcolor_is_rgb () const { return m_xcolor.is_rgb (); }
  bool xcolor_is (const std::string& v) const { return m_xcolor.is (v); }
  Matrix get_xcolor_rgb () const { return (m_xcolor.is_rgb () ? m_xcolor.rgb () : Matrix ()); }
  octave_value get_xcolor () const { return m_xcolor.get (); }

  bool xcolormode_is (const std::string& v) const { return m_xcolormode.is (v); }
  std::string get_xcolormode () const { return m_xcolormode.current_value (); }

  bool xdir_is (const std::string& v) const { return m_xdir.is (v); }
  std::string get_xdir () const { return m_xdir.current_value (); }

  bool is_xgrid () const { return m_xgrid.is_on (); }
  std::string get_xgrid () const { return m_xgrid.current_value (); }

  graphics_handle get_xlabel () const { return m_xlabel.handle_value (); }

  octave_value get_xlim () const { return m_xlim.get (); }

  bool xlimitmethod_is (const std::string& v) const { return m_xlimitmethod.is (v); }
  std::string get_xlimitmethod () const { return m_xlimitmethod.current_value (); }

  bool xlimmode_is (const std::string& v) const { return m_xlimmode.is (v); }
  std::string get_xlimmode () const { return m_xlimmode.current_value (); }

  bool is_xminorgrid () const { return m_xminorgrid.is_on (); }
  std::string get_xminorgrid () const { return m_xminorgrid.current_value (); }

  bool is_xminortick () const { return m_xminortick.is_on (); }
  std::string get_xminortick () const { return m_xminortick.current_value (); }

  octave_value get_xminortickvalues () const { return m_xminortickvalues.get (); }

  bool xminortickvaluesmode_is (const std::string& v) const { return m_xminortickvaluesmode.is (v); }
  std::string get_xminortickvaluesmode () const { return m_xminortickvaluesmode.current_value (); }

  bool xscale_is (const std::string& v) const { return m_xscale.is (v); }
  std::string get_xscale () const { return m_xscale.current_value (); }

  octave_value get_xtick () const { return m_xtick.get (); }

  octave_value get_xticklabel () const { return m_xticklabel.get (); }

  bool xticklabelmode_is (const std::string& v) const { return m_xticklabelmode.is (v); }
  std::string get_xticklabelmode () const { return m_xticklabelmode.current_value (); }

  double get_xticklabelrotation () const { return m_xticklabelrotation.double_value (); }

  bool xtickmode_is (const std::string& v) const { return m_xtickmode.is (v); }
  std::string get_xtickmode () const { return m_xtickmode.current_value (); }

  graphics_handle get_yaxis () const { return m_yaxis.handle_value (); }

  bool yaxislocation_is (const std::string& v) const { return m_yaxislocation.is (v); }
  std::string get_yaxislocation () const { return m_yaxislocation.current_value (); }

  bool ycolor_is_rgb () const { return m_ycolor.is_rgb (); }
  bool ycolor_is (const std::string& v) const { return m_ycolor.is (v); }
  Matrix get_ycolor_rgb () const { return (m_ycolor.is_rgb () ? m_ycolor.rgb () : Matrix ()); }
  octave_value get_ycolor () const { return m_ycolor.get (); }

  bool ycolormode_is (const std::string& v) const { return m_ycolormode.is (v); }
  std::string get_ycolormode () const { return m_ycolormode.current_value (); }

  bool ydir_is (const std::string& v) const { return m_ydir.is (v); }
  std::string get_ydir () const { return m_ydir.current_value (); }

  bool is_ygrid () const { return m_ygrid.is_on (); }
  std::string get_ygrid () const { return m_ygrid.current_value (); }

  graphics_handle get_ylabel () const { return m_ylabel.handle_value (); }

  octave_value get_ylim () const { return m_ylim.get (); }

  bool ylimitmethod_is (const std::string& v) const { return m_ylimitmethod.is (v); }
  std::string get_ylimitmethod () const { return m_ylimitmethod.current_value (); }

  bool ylimmode_is (const std::string& v) const { return m_ylimmode.is (v); }
  std::string get_ylimmode () const { return m_ylimmode.current_value (); }

  bool is_yminorgrid () const { return m_yminorgrid.is_on (); }
  std::string get_yminorgrid () const { return m_yminorgrid.current_value (); }

  bool is_yminortick () const { return m_yminortick.is_on (); }
  std::string get_yminortick () const { return m_yminortick.current_value (); }

  octave_value get_yminortickvalues () const { return m_yminortickvalues.get (); }

  bool yminortickvaluesmode_is (const std::string& v) const { return m_yminortickvaluesmode.is (v); }
  std::string get_yminortickvaluesmode () const { return m_yminortickvaluesmode.current_value (); }

  bool yscale_is (const std::string& v) const { return m_yscale.is (v); }
  std::string get_yscale () const { return m_yscale.current_value (); }

  octave_value get_ytick () const { return m_ytick.get (); }

  octave_value get_yticklabel () const { return m_yticklabel.get (); }

  bool yticklabelmode_is (const std::string& v) const { return m_yticklabelmode.is (v); }
  std::string get_yticklabelmode () const { return m_yticklabelmode.current_value (); }

  double get_yticklabelrotation () const { return m_yticklabelrotation.double_value (); }

  bool ytickmode_is (const std::string& v) const { return m_ytickmode.is (v); }
  std::string get_ytickmode () const { return m_ytickmode.current_value (); }

  graphics_handle get_zaxis () const { return m_zaxis.handle_value (); }

  bool zcolor_is_rgb () const { return m_zcolor.is_rgb (); }
  bool zcolor_is (const std::string& v) const { return m_zcolor.is (v); }
  Matrix get_zcolor_rgb () const { return (m_zcolor.is_rgb () ? m_zcolor.rgb () : Matrix ()); }
  octave_value get_zcolor () const { return m_zcolor.get (); }

  bool zcolormode_is (const std::string& v) const { return m_zcolormode.is (v); }
  std::string get_zcolormode () const { return m_zcolormode.current_value (); }

  bool zdir_is (const std::string& v) const { return m_zdir.is (v); }
  std::string get_zdir () const { return m_zdir.current_value (); }

  bool is_zgrid () const { return m_zgrid.is_on (); }
  std::string get_zgrid () const { return m_zgrid.current_value (); }

  graphics_handle get_zlabel () const { return m_zlabel.handle_value (); }

  octave_value get_zlim () const { return m_zlim.get (); }

  bool zlimitmethod_is (const std::string& v) const { return m_zlimitmethod.is (v); }
  std::string get_zlimitmethod () const { return m_zlimitmethod.current_value (); }

  bool zlimmode_is (const std::string& v) const { return m_zlimmode.is (v); }
  std::string get_zlimmode () const { return m_zlimmode.current_value (); }

  bool is_zminorgrid () const { return m_zminorgrid.is_on (); }
  std::string get_zminorgrid () const { return m_zminorgrid.current_value (); }

  bool is_zminortick () const { return m_zminortick.is_on (); }
  std::string get_zminortick () const { return m_zminortick.current_value (); }

  octave_value get_zminortickvalues () const { return m_zminortickvalues.get (); }

  bool zminortickvaluesmode_is (const std::string& v) const { return m_zminortickvaluesmode.is (v); }
  std::string get_zminortickvaluesmode () const { return m_zminortickvaluesmode.current_value (); }

  bool zscale_is (const std::string& v) const { return m_zscale.is (v); }
  std::string get_zscale () const { return m_zscale.current_value (); }

  octave_value get_ztick () const { return m_ztick.get (); }

  octave_value get_zticklabel () const { return m_zticklabel.get (); }

  bool zticklabelmode_is (const std::string& v) const { return m_zticklabelmode.is (v); }
  std::string get_zticklabelmode () const { return m_zticklabelmode.current_value (); }

  double get_zticklabelrotation () const { return m_zticklabelrotation.double_value (); }

  bool ztickmode_is (const std::string& v) const { return m_ztickmode.is (v); }
  std::string get_ztickmode () const { return m_ztickmode.current_value (); }

  octave_value get___colormap__ () const { return m___colormap__.get (); }

  double get_mousewheelzoom () const { return m_mousewheelzoom.double_value (); }

  bool __autopos_tag___is (const std::string& v) const { return m___autopos_tag__.is (v); }
  std::string get___autopos_tag__ () const { return m___autopos_tag__.current_value (); }

  octave_value get_looseinset () const { return m_looseinset.get (); }
  ...
  {
    if (m_xlimitmethod.set (val, true))
      {
        update_xlimitmethod ();
        mark_modified ();
      }
  ...
  {
    if (m_xminortickvalues.set (val, false))
      {
        set_xminortickvaluesmode ("manual");
        m_xminortickvalues.run_listeners (GCB_POSTSET);
        mark_modified ();
      }
    else
      set_xminortickvaluesmode ("manual");
  ...
  void set_xminortickvaluesmode (const octave_value& val)
  {
    if (m_xminortickvaluesmode.set (val, true))
      {
        update_xminortickvaluesmode ();
        mark_modified ();
      }
  }
  ...
  {
    if (m_ylimitmethod.set (val, true))
      {
        update_ylimitmethod ();
        mark_modified ();
      }
  ...
  {
    if (m_yminortickvalues.set (val, false))
      {
        set_yminortickvaluesmode ("manual");
        m_yminortickvalues.run_listeners (GCB_POSTSET);
        mark_modified ();
      }
    else
      set_yminortickvaluesmode ("manual");
  ...
  void set_yminortickvaluesmode (const octave_value& val)
  {
    if (m_yminortickvaluesmode.set (val, true))
      {
        update_yminortickvaluesmode ();
        mark_modified ();
      }
  }
  ...
  {
    if (m_zlimitmethod.set (val, true))
      {
        update_zlimitmethod ();
        mark_modified ();
      }
  ...
  {
    if (m_zminortickvalues.set (val, false))
      {
        set_zminortickvaluesmode ("manual");
        m_zminortickvalues.run_listeners (GCB_POSTSET);
        mark_modified ();
      }
    else
      set_zminortickvaluesmode ("manual");
  ...
  void set_zminortickvaluesmode (const octave_value& val)
  {
    if (m_zminortickvaluesmode.set (val, true))
      {
        update_zminortickvaluesmode ();
        mark_modified ();
      }
  }
...
public:
  ...
  std::string get_displayname () const { return m_displayname.string_value (); }

  bool linejoin_is (const std::string& v) const { return m_linejoin.is (v); }
  std::string get_linejoin () const { return m_linejoin.current_value (); }

  bool linestyle_is (const std::string& v) const { return m_linestyle.is (v); }
  std::string get_linestyle () const { return m_linestyle.current_value (); }

  double get_linewidth () const { return m_linewidth.double_value (); }

  bool marker_is (const std::string& v) const { return m_marker.is (v); }
  std::string get_marker () const { return m_marker.current_value (); }

  bool markeredgecolor_is_rgb () const { return m_markeredgecolor.is_rgb (); }
  bool markeredgecolor_is (const std::string& v) const { return m_markeredgecolor.is (v); }
  Matrix get_markeredgecolor_rgb () const { return (m_markeredgecolor.is_rgb () ? m_markeredgecolor.rgb () : Matrix ()); }
  octave_value get_markeredgecolor () const { return m_markeredgecolor.get (); }

  bool markerfacecolor_is_rgb () const { return m_markerfacecolor.is_rgb (); }
  bool markerfacecolor_is (const std::string& v) const { return m_markerfacecolor.is (v); }
  Matrix get_markerfacecolor_rgb () const { return (m_markerfacecolor.is_rgb () ? m_markerfacecolor.rgb () : Matrix ()); }
  octave_value get_markerfacecolor () const { return m_markerfacecolor.get (); }

  double get_markersize () const { return m_markersize.double_value (); }

  octave_value get_xdata () const { return m_xdata.get (); }

  std::string get_xdatasource () const { return m_xdatasource.string_value (); }

  octave_value get_ydata () const { return m_ydata.get (); }

  std::string get_ydatasource () const { return m_ydatasource.string_value (); }

  octave_value get_zdata () const { return m_zdata.get (); }

  std::string get_zdatasource () const { return m_zdatasource.string_value (); }
  ...
  bool is_xliminclude () const { return m_xliminclude.is_on (); }
  std::string get_xliminclude () const { return m_xliminclude.current_value (); }

  bool is_yliminclude () const { return m_yliminclude.is_on (); }
  std::string get_yliminclude () const { return m_yliminclude.current_value (); }

  bool is_zliminclude () const { return m_zliminclude.is_on (); }
  std::string get_zliminclude () const { return m_zliminclude.current_value (); }
...
public:
  ...
  bool backgroundcolor_is_rgb () const { return m_backgroundcolor.is_rgb (); }
  bool backgroundcolor_is (const std::string& v) const { return m_backgroundcolor.is (v); }
  Matrix get_backgroundcolor_rgb () const { return (m_backgroundcolor.is_rgb () ? m_backgroundcolor.rgb () : Matrix ()); }
  octave_value get_backgroundcolor () const { return m_backgroundcolor.get (); }
  ...
  bool edgecolor_is_rgb () const { return m_edgecolor.is_rgb (); }
  bool edgecolor_is (const std::string& v) const { return m_edgecolor.is (v); }
  Matrix get_edgecolor_rgb () const { return (m_edgecolor.is_rgb () ? m_edgecolor.rgb () : Matrix ()); }
  octave_value get_edgecolor () const { return m_edgecolor.get (); }

  bool is_editing () const { return m_editing.is_on (); }
  std::string get_editing () const { return m_editing.current_value (); }
  ...
  std::string get_horizontalalignment () const { return m_horizontalalignment.current_value (); }

  bool interpreter_is (const std::string& v) const { return m_interpreter.is (v); }
  std::string get_interpreter () const { return m_interpreter.current_value (); }
  ...
  double get_margin () const { return m_margin.double_value (); }

  octave_value get_position () const { return m_position.get (); }

  double get_rotation () const { return m_rotation.double_value (); }

  octave_value get_string () const { return m_string.get (); }

  bool units_is (const std::string& v) const { return m_units.is (v); }
  std::string get_units () const { return m_units.current_value (); }

  bool verticalalignment_is (const std::string& v) const { return m_verticalalignment.is (v); }
  std::string get_verticalalignment () const { return m_verticalalignment.current_value (); }
  ...
  std::string get_positionmode () const { return m_positionmode.current_value (); }

  bool rotationmode_is (const std::string& v) const { return m_rotationmode.is (v); }
  std::string get_rotationmode () const { return m_rotationmode.current_value (); }

  bool horizontalalignmentmode_is (const std::string& v) const { return m_horizontalalignmentmode.is (v); }
  std::string get_horizontalalignmentmode () const { return m_horizontalalignmentmode.current_value (); }

  bool verticalalignmentmode_is (const std::string& v) const { return m_verticalalignmentmode.is (v); }
  std::string get_verticalalignmentmode () const { return m_verticalalignmentmode.current_value (); }
...
public:
  ...
  octave_value get_alphadata () const { return m_alphadata.get (); }

  bool alphadatamapping_is (const std::string& v) const { return m_alphadatamapping.is (v); }
  std::string get_alphadatamapping () const { return m_alphadatamapping.current_value (); }

  octave_value get_cdata () const { return m_cdata.get (); }

  bool cdatamapping_is (const std::string& v) const { return m_cdatamapping.is (v); }
  std::string get_cdatamapping () const { return m_cdatamapping.current_value (); }
  ...
  std::string get_xdatamode () const { return m_xdatamode.current_value (); }

  bool ydatamode_is (const std::string& v) const { return m_ydatamode.is (v); }
  std::string get_ydatamode () const { return m_ydatamode.current_value (); }
...
public:
  ...
  std::string get_style () const { return m_style.current_value (); }
...
public:
  ...
  double get_ambientstrength () const { return m_ambientstrength.double_value (); }

  bool backfacelighting_is (const std::string& v) const { return m_backfacelighting.is (v); }
  std::string get_backfacelighting () const { return m_backfacelighting.current_value (); }
  ...
  double get_diffusestrength () const { return m_diffusestrength.double_value (); }

  std::string get_displayname () const { return m_displayname.string_value (); }

  bool edgealpha_is_double () const { return m_edgealpha.is_double (); }
  bool edgealpha_is (const std::string& v) const { return m_edgealpha.is (v); }
  double get_edgealpha_double () const { return (m_edgealpha.is_double () ? m_edgealpha.double_value () : 0); }
  octave_value get_edgealpha () const { return m_edgealpha.get (); }
  ...
  std::string get_edgelighting () const { return m_edgelighting.current_value (); }

  bool facealpha_is_double () const { return m_facealpha.is_double (); }
  bool facealpha_is (const std::string& v) const { return m_facealpha.is (v); }
  double get_facealpha_double () const { return (m_facealpha.is_double () ? m_facealpha.double_value () : 0); }
  octave_value get_facealpha () const { return m_facealpha.get (); }

  bool facecolor_is_rgb () const { return m_facecolor.is_rgb (); }
  bool facecolor_is (const std::string& v) const { return m_facecolor.is (v); }
  Matrix get_facecolor_rgb () const { return (m_facecolor.is_rgb () ? m_facecolor.rgb () : Matrix ()); }
  octave_value get_facecolor () const { return m_facecolor.get (); }

  bool facelighting_is (const std::string& v) const { return m_facelighting.is (v); }
  std::string get_facelighting () const { return m_facelighting.current_value (); }

  octave_value get_facenormals () const { return m_facenormals.get (); }

  bool facenormalsmode_is (const std::string& v) const { return m_facenormalsmode.is (v); }
  std::string get_facenormalsmode () const { return m_facenormalsmode.current_value (); }

  octave_value get_faces () const { return m_faces.get (); }

  octave_value get_facevertexalphadata () const { return m_facevertexalphadata.get (); }

  octave_value get_facevertexcdata () const { return m_facevertexcdata.get (); }
  ...
  double get_specularcolorreflectance () const { return m_specularcolorreflectance.double_value (); }

  double get_specularexponent () const { return m_specularexponent.double_value (); }

  double get_specularstrength () const { return m_specularstrength.double_value (); }

  octave_value get_vertexnormals () const { return m_vertexnormals.get (); }

  bool vertexnormalsmode_is (const std::string& v) const { return m_vertexnormalsmode.is (v); }
  std::string get_vertexnormalsmode () const { return m_vertexnormalsmode.current_value (); }

  octave_value get_vertices () const { return m_vertices.get (); }
...
public:
  ...
  octave_value get_annotation () const { return m_annotation.get (); }

  octave_value get_cdata () const { return m_cdata.get (); }

  bool cdatamode_is (const std::string& v) const { return m_cdatamode.is (v); }
  std::string get_cdatamode () const { return m_cdatamode.current_value (); }

  std::string get_cdatasource () const { return m_cdatasource.string_value (); }

  octave_value get_datatiptemplate () const { return m_datatiptemplate.get (); }

  std::string get_displayname () const { return m_displayname.string_value (); }

  octave_value get_latitudedata () const { return m_latitudedata.get (); }

  std::string get_latitudedatasource () const { return m_latitudedatasource.string_value (); }

  double get_linewidth () const { return m_linewidth.double_value (); }

  octave_value get_longitudedata () const { return m_longitudedata.get (); }

  std::string get_longitudedatasource () const { return m_longitudedatasource.string_value (); }

  bool marker_is (const std::string& v) const { return m_marker.is (v); }
  std::string get_marker () const { return m_marker.current_value (); }

  double get_markeredgealpha () const { return m_markeredgealpha.double_value (); }
  ...
  double get_markerfacealpha () const { return m_markerfacealpha.double_value (); }
  ...
  octave_value get_rdata () const { return m_rdata.get (); }

  std::string get_rdatasource () const { return m_rdatasource.string_value (); }

  octave_value get_seriesindex () const { return m_seriesindex.get (); }

  octave_value get_sizedata () const { return m_sizedata.get (); }

  std::string get_sizedatasource () const { return m_sizedatasource.string_value (); }

  octave_value get_thetadata () const { return m_thetadata.get (); }

  std::string get_thetadatasource () const { return m_thetadatasource.string_value (); }
...
public:
  ...
  std::string get_meshstyle () const { return m_meshstyle.current_value (); }
...
public:
  ...
  bool is_aliminclude () const { return m_aliminclude.is_on (); }
  std::string get_aliminclude () const { return m_aliminclude.current_value (); }

  bool is_climinclude () const { return m_climinclude.is_on (); }
  std::string get_climinclude () const { return m_climinclude.current_value (); }
...
private:
  ...
  callback_property m_menuselectedfcn;
...
public:
  ...
  enum
  {
    ...
    ID_LABEL = 12005,
    ID_MENUSELECTEDFCN = 12006,
    ID_POSITION = 12007,
    ID_SEPARATOR = 12008,
    ID_TEXT = 12009,
    ID___FLTK_LABEL__ = 12010,
    ID___OBJECT__ = 12011
  };

  std::string get_accelerator () const { return m_accelerator.string_value (); }

  bool is_checked () const { return m_checked.is_on (); }
  std::string get_checked () const { return m_checked.current_value (); }

  bool is_enable () const { return m_enable.is_on (); }
  std::string get_enable () const { return m_enable.current_value (); }

  bool foregroundcolor_is_rgb () const { return m_foregroundcolor.is_rgb (); }
  bool foregroundcolor_is (const std::string& v) const { return m_foregroundcolor.is (v); }
  Matrix get_foregroundcolor_rgb () const { return (m_foregroundcolor.is_rgb () ? m_foregroundcolor.rgb () : Matrix ()); }
  octave_value get_foregroundcolor () const { return m_foregroundcolor.get (); }

  void execute_menuselectedfcn (const octave_value& new_data = octave_value ()) const { m_menuselectedfcn.execute (new_data); }
  octave_value get_menuselectedfcn () const { return m_menuselectedfcn.get (); }

  double get_position () const { return m_position.double_value (); }

  bool is_separator () const { return m_separator.is_on (); }
  std::string get_separator () const { return m_separator.current_value (); }

  std::string get_text () const { return m_text.string_value (); }

  std::string get___fltk_label__ () const { return m___fltk_label__.string_value (); }

  octave_value get___object__ () const { return m___object__.get (); }
  ...
  {
    if (m_menuselectedfcn.set (val, true))
      {
        mark_modified ();
      }
  }
...
public:
  ...
  octave_value get_callback () const { return m_callback.get (); }
...
public:
  ...
  double get_listboxtop () const { return m_listboxtop.double_value (); }

  double get_max () const { return m_max.double_value (); }

  double get_min () const { return m_min.double_value (); }

  octave_value get_position () const { return m_position.get (); }

  octave_value get_sliderstep () const { return m_sliderstep.get (); }

  std::string get_string_string () const { return m_string.string_value (); }
  string_vector get_string_vector () const { return m_string.string_vector_value (); }
  octave_value get_string () const { return m_string.get (); }

  bool style_is (const std::string& v) const { return m_style.is (v); }
  std::string get_style () const { return m_style.current_value (); }

  std::string get_tooltipstring () const { return m_tooltipstring.string_value (); }

  bool units_is (const std::string& v) const { return m_units.is (v); }
  std::string get_units () const { return m_units.current_value (); }

  octave_value get_value () const { return m_value.get (); }

  bool verticalalignment_is (const std::string& v) const { return m_verticalalignment.is (v); }
  std::string get_verticalalignment () const { return m_verticalalignment.current_value (); }

  bool is___focus__ () const { return m___focus__.is_on (); }
  std::string get___focus__ () const { return m___focus__.current_value (); }
...
public:
  ...
  std::string get_bordertype () const { return m_bordertype.current_value (); }

  double get_borderwidth () const { return m_borderwidth.double_value (); }
  ...
  bool highlightcolor_is_rgb () const { return m_highlightcolor.is_rgb (); }
  bool highlightcolor_is (const std::string& v) const { return m_highlightcolor.is (v); }
  Matrix get_highlightcolor_rgb () const { return (m_highlightcolor.is_rgb () ? m_highlightcolor.rgb () : Matrix ()); }
  octave_value get_highlightcolor () const { return m_highlightcolor.get (); }
  ...
  graphics_handle get_selectedobject () const { return m_selectedobject.handle_value (); }

  void execute_selectionchangedfcn (const octave_value& new_data = octave_value ()) const { m_selectionchangedfcn.execute (new_data); }
  octave_value get_selectionchangedfcn () const { return m_selectionchangedfcn.get (); }

  bool shadowcolor_is_rgb () const { return m_shadowcolor.is_rgb (); }
  bool shadowcolor_is (const std::string& v) const { return m_shadowcolor.is (v); }
  Matrix get_shadowcolor_rgb () const { return (m_shadowcolor.is_rgb () ? m_shadowcolor.rgb () : Matrix ()); }
  octave_value get_shadowcolor () const { return m_shadowcolor.get (); }
  ...
  std::string get_title () const { return m_title.string_value (); }

  bool titleposition_is (const std::string& v) const { return m_titleposition.is (v); }
  std::string get_titleposition () const { return m_titleposition.current_value (); }
...
public:
  ...
  octave_value get_celleditcallback () const { return m_celleditcallback.get (); }
  ...
  octave_value get_cellselectioncallback () const { return m_cellselectioncallback.get (); }

  octave_value get_columneditable () const { return m_columneditable.get (); }

  octave_value get_columnformat () const { return m_columnformat.get (); }

  octave_value get_columnname () const { return m_columnname.get (); }

  octave_value get_columnwidth () const { return m_columnwidth.get (); }

  octave_value get_data () const { return m_data.get (); }
  ...
  bool is_rearrangeablecolumns () const { return m_rearrangeablecolumns.is_on (); }
  std::string get_rearrangeablecolumns () const { return m_rearrangeablecolumns.current_value (); }

  octave_value get_rowname () const { return m_rowname.get (); }

  bool is_rowstriping () const { return m_rowstriping.is_on (); }
  std::string get_rowstriping () const { return m_rowstriping.current_value (); }
...
public:
  ...
  octave_value get_clickedcallback () const { return m_clickedcallback.get (); }
  ...
  std::string get___named_icon__ () const { return m___named_icon__.string_value (); }
...
public:
  ...
  octave_value get_offcallback () const { return m_offcallback.get (); }

  void execute_oncallback (const octave_value& new_data = octave_value ()) const { m_oncallback.execute (new_data); }
  octave_value get_oncallback () const { return m_oncallback.get (); }

  bool is_separator () const { return m_separator.is_on (); }
  std::string get_separator () const { return m_separator.current_value (); }

  bool is_state () const { return m_state.is_on (); }
  std::string get_state () const { return m_state.current_value (); }
