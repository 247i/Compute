...
#include "Sparse-op-defs.h"
  ...
  extern OCTAVE_API ComplexMatrix quotient (const Matrix&, const SparseComplexMatrix&);
  ...
  extern OCTAVE_API boolMatrix mx_el_or (const Matrix&, const SparseComplexMatrix&);
#endif
