...
#define GDCM_SOURCE_DIR "/scratch/build/mxe-octave-w64/tmp-gdcm/GDCM-3.2.2"
#define GDCM_EXECUTABLE_OUTPUT_PATH "/scratch/build/mxe-octave-w64/tmp-gdcm/.build/bin"
#define GDCM_LIBRARY_OUTPUT_PATH    "/scratch/build/mxe-octave-w64/tmp-gdcm/.build/bin"
...
#define GDCM_CMAKE_INSTALL_PREFIX "/scratch/build/mxe-octave-w64/usr/x86_64-w64-mingw32"
