...
#define CONFIGURE_ARGS " 'ac_cv_func_getaddrinfo=no' '--prefix=/scratch/build/mxe-octave-w64/usr/x86_64-w64-mingw32' '--host=x86_64-w64-mingw32' '--build=x86_64-pc-linux-gnu' '--enable-shared' '--disable-static' '--with-libraries=/scratch/build/mxe-octave-w64/usr/x86_64-w64-mingw32/lib' '--disable-rpath' '--without-tcl' '--without-perl' '--without-python' '--without-gssapi' '--without-krb5' '--without-pam' '--without-ldap' '--without-bonjour' '--without-openssl' '--without-readline' '--without-ossp-uuid' '--without-libxml' '--without-libxslt' '--with-zlib' '--with-system-tzdata=/dev/null' 'LIBS=-lsecur32' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=x86_64-w64-mingw32' 'PKG_CONFIG_PATH=/scratch/build/mxe-octave-w64/usr/x86_64-w64-mingw32/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 14.20 on x86_64-w64-mingw32, compiled by x86_64-w64-mingw32-gcc (GCC) 15.2.0, 64-bit"
